  ...
  let options = {
    renderNode: {
      ...
      [BLOCKS.EMBEDDED_ASSET]: (node) => {
        return `<img class="content-img" src="${node.data.target.fields.file.url}"/>`;
      },
    },
  };
      ...
      <>
        <div className="project__intro" style={{ backgroundColor: project.color }}>
          <div className="project__intro__img">
            <div
              className="project__intro__img__cover"
          ...
          <div className="project__intro__text">
            <h2 id="left" className="project__intro__text__title" ref={left}>
              {project.title}
            </h2>
            <h2 id="right" className="project__intro__text__title" ref={right}>
              {project.title}
            </h2>
          </div>
        </div>

        <div className="project__body">{parse(documentToHtmlString(project.body, options))}</div>
      </>
    );
  };
